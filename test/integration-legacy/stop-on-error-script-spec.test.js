            ...
            runner.run(collection, {
                ...
                run.start({
                    ...
                    request: function (err, cursor, response, request, item) {
                        ...
                        expect(testables.iterationsStarted).to.eql([0, 1, 2]);
                        expect(testables.iterationsComplete).to.eql([0, 1, 2]);
                        ...
                        // Third iteration
                        expect(testables.itemsStarted[2].length).to.be(3);
                        expect(testables.itemsComplete[2].length).to.be(3);
