...
_.assignIn(Cursor.prototype, {
    ...
    whatnext: function (coords) {
        ...
        if (!_.isObject(coords)) {
            return _.assignIn(base, {eof: true, bof: true, empty: this.empty()});
        }
        if (!this.length) {
            return _.assignIn(base, {eof: true, bof: true, empty: true});
        }
        ...
        return _.assignIn(base, {position: position, iteration: iteration});
    },
