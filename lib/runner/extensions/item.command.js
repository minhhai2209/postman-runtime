        ...
        item: function (callback, payload, next) {
            ...
            this.queueDelay(function () {
                ...
                ctxTemplate = {
                    ...
                    // items to be passed on to postman api
                    pm: {}
                };

                ctxTemplate.pm.request = item.request.toJSON();
                ctxTemplate.pm.environment = environment.toJSON();
                ctxTemplate.pm.globals = environment.toJSON();
                ...
                this.queue('event', {
                    ...
                    this.queue('request', {
                        ...
                        ctxTemplate.pm.request = request.toJSON();
                        ctxTemplate.pm.response = response.toJSON();
                        ctxTemplate.pm.environment = environment.toJSON();
                        ctxTemplate.pm.globals = environment.toJSON();
