...
_.assignIn(NodeHost.prototype, /** @lends NodeHost.prototype */ {
    ...
    _run: function (code, options, errors) {
        ...
        try {
            vm.runInContext(sandboxClientCode, _.assignIn(this.context, {
                code: code,
                ...
                __done: options.done,
                __delete: {
                    // These objects are removed from the context before running user code
                    before: [
                        '__masked',
                        '__require',
                        '__cursor'
                    ],
                    // These objects are removed from the context after running user code
                    final: [
                        '__globals',
                        '__async',
                        '__done',
